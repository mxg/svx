module containers_testsuite;
  ...
  function void build();
    ...
    vector_ut.build();
    vector_ut.__register_tests();
    map_ut.build();
    map_ut.__register_tests();
    singleton_map_ut.build();
    singleton_map_ut.__register_tests();
    queue_ut.build();
    queue_ut.__register_tests();
    fixed_size_queue_ut.build();
    fixed_size_queue_ut.__register_tests();
    deque_ut.build();
    deque_ut.__register_tests();
    stack_ut.build();
